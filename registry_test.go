...
func TestRegistryAddAndList(t *testing.T) {
	...
	err := r.Add(ChainConfig{
		Slug:   "cchain",
		Name:   "C-Chain",
		RPC:    "http://localhost:9650/v1/chain/C/rpc",
		Type:   "evm",
		Source: "config",
	})
	if err != nil {
...
func TestRegistryLoadFromEnv(t *testing.T) {
	r := NewChainRegistry()
	r.LoadFromEnv("cchain:http://localhost:9650/v1/chain/C/rpc,zoo:http://localhost:9650/v1/chain/Zoo/rpc")
...
func TestRegistryLoadFromFile(t *testing.T) {
  ...
  - slug: zoo
    name: Zoo
    chain_id: 200200
    rpc: http://localhost:9650/v1/chain/Zoo/rpc
    type: evm
`), 0644)
...
func TestHandleAddAndRemove(t *testing.T) {
	...
	// Add
	payload := `{"slug":"cchain","name":"C-Chain","rpc":"http://localhost:9650/v1/chain/C/rpc","type":"evm"}`
...
func TestHTTPIntegration(t *testing.T) {
	...
	// Add
	addPayload := `{"slug":"cchain","name":"C-Chain","chain_id":96369,"rpc":"http://localhost:9650/v1/chain/C/rpc","type":"evm","default":true}`
	...
	// Update
	updatePayload := `{"name":"Lux C-Chain","rpc":"http://new:9650/v1/chain/C/rpc"}`
...
func TestChainEnabledGatesRegistration(t *testing.T) {
	on, off := true, false
	base := ChainConfig{RPC: "http://localhost:9650/v1/chain/C/rpc", Type: "evm", Source: "config"}
...
func TestDisabledChainNeverStartsIndexer(t *testing.T) {
	...
	if err := r.Add(ChainConfig{
		Slug: "spc", RPC: "http://localhost:9650/v1/chain/spc/rpc", Type: "evm",
